...
public class GameSaver {
    ...
    private static JSONObject getEmergency(Aircraft aircraft) {
        ...
        emer.put("fuelDumpTime", (double) aircraft.getEmergency().getFuelDumpTime());
        emer.put("remainingTimeSaid", aircraft.getEmergency().isRemainingTimeSaid());
    ...
    public static void saveSettings(int trajectorySel, RadarScreen.Weather weatherSel, int soundSel, boolean sendCrash, boolean increaseZoom, Emergency.Chance emerChance, int revision) {
