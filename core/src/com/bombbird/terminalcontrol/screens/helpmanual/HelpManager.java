...
public class HelpManager {
    ...
    private static void loadHashMap() {
        ...
        CONTENT_LIST.put("RCTP", new String[] {"RCTP, Taiwan Taoyuan International Airport", "Runways:", "05L-23R: 3660m", "05R-23L: 3800m", "Configurations: 05L and 05R or 23L and 23R",
                ...
                "RCSS, Taipei Songshan Airport", "Runway:", "10-28: 2605m", "Configurations: 10 or 28", "Runway is used for both arrivals, departures. When 28 is in use, planes will use the LDA28 approach which is a non-precision approach with step down altitudes."});
        ...
        CONTENT_LIST.put("VHHH", new String[] {"VHHH, Hong Kong International Airport", "Runways:", "07L-25R: 3800m", "07R-25L: 3800m", "Configurations: 07L and 07R or 25L and 25R",
                ...
                "VMMC, Macau International Airport", "Runways:", "16-34: 3360m", "Configurations: 16 and 34", "Runway is used for both arrivals, departures. When 16 is in use, planes will use the LDA16 approach which is a non-precision approach",
        ...
        CONTENT_LIST.put("LFPG", new String[] {"LFPG, Paris Charles de Gaulle Airport", "Runways:", "08L-26R: 4215m", "08R-26L: 2700m", "09L-27R: 2700m", "09R-27L: 4200m", "Configurations: 08L, 08R, 09L and 09R or 26L, 26R, 27L and 27R",
                ...
                "LFPG STARs end early on, and planes will need to be vectored manually to the ILS. When vectoring south-east or south-west arrivals, depending on the runway configuration, you will also need to be aware of the restricted area over Paris City, as well as LFPO traffic.",
